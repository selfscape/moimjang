...
export const noReviewUsers: Array<Review> = [
  {
    is_reviewer_anonymous: true,
    channel_id: 10,
    style:
      "[캐주얼]\n 편안하고 일상적인 복장, [노멀]\n 튀지 않고 무난한 스타일, [미니멀]\n 단순하고 심플한 디자인",
    impression:
      "차분하고 진지함:\n 신중하면서 안정감이 느껴짐, 따뜻하고 배려심 있음:\n 부드럽고 포용력 있는 느낌",
    conversation:
      "이야기 내용과 흥미:\n이야기의 주제나 내용이 흥미롭고 사람의 관심을 끌었음. 새로운 정보를 제공하거나 흥미로운 관점을 제시함, 공감하고 경청하는 태도:\n 상대방의 말에 집중하고 진지하게 경청하며 공감을 표현함. 상대방이 존중받고 있다는 느낌을 받음, 편안하고 자연스러움:\n 대화가 편안하고 자연스러워 아무런 노력 없이 흘러갔음, 친절하고 배려심 있는 대화 태도:\n 상대방이 나의 의견을 존중하며 대화에 참여함",
    additional_info: "",
    keywords: "편안함, 따듯함, 평화로움",
    id: 353,
    created_at: "2025-03-10T08:02:41.510367",
    reviewer_user_gender: "anonymous",
    reviewer_user_name: "anonymous",
  },
  {
    is_reviewer_anonymous: true,
    channel_id: 10,
    style:
      "[노멀]\n 튀지 않고 무난한 스타일, [미니멀]\n 단순하고 심플한 디자인",
    impression:
      "신뢰감 있음:\n 안정적이고 믿을 수 있는 인상을 줌, 섬세하고 관찰력 있음:\n 작은 디테일까지 잘 캐치하며 세심한 느낌을 줌",
    conversation:
      "이야기 내용과 흥미:\n이야기의 주제나 내용이 흥미롭고 사람의 관심을 끌었음. 새로운 정보를 제공하거나 흥미로운 관점을 제시함, 편안하고 자연스러움:\n 대화가 편안하고 자연스러워 아무런 노력 없이 흘러갔음, 친절하고 배려심 있는 대화 태도:\n 상대방이 나의 의견을 존중하며 대화에 참여함, 자신감 있는 표현:\n 자신의 생각을 명확하고 자신 있게 표현함",
    additional_info: "",
    keywords: "진지한, 배려깊은, 친절한, 편안함, 단정한",
    id: 354,
    created_at: "2025-03-10T08:02:41.510367",
    reviewer_user_gender: "anonymous",
    reviewer_user_name: "anonymous",
