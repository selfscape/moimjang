    ...
    <Container>
      <Tabs>
        {isSuperAdmin && (
          <Tab
            isActive={
              location.pathname.includes(AdminPathnames.Submission) ||
              (location.pathname === "/admin" && isSuperAdmin)
            }
            onClick={() => handleTabClick(AdminPathnames.Submission)}
          >
            신청
          </Tab>
        )}
        ...
        {isAdmin && (
          <Tab
            isActive={
              location.pathname.includes(AdminPathnames.Host) ||
              (location.pathname === "/admin" && isAdmin)
            }
            onClick={() => handleTabClick(AdminPathnames.Host)}
          >
            모임장
          </Tab>
        )}
        ...
        <Tab
          isActive={location.pathname.includes(AdminPathnames.Landing)}
          onClick={() => handleTabClick(AdminPathnames.Landing)}
        >
          메인 페이지
        </Tab>
      </Tabs>
