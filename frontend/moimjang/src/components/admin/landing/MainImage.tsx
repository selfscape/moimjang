...
import useUploadMainImage from "api/admin/landing/hooks/useUploadMainImage";
import useDeleteMainImage from "api/admin/landing/hooks/useDeleteMainImage";
import useGetMainImage from "api/admin/landing/hooks/useGetMainImage";
