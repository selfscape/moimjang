...
import useUploadGalleryImage from "api/admin/landing/hooks/useUploadGalleryImage";
import useDeleteGalleryImage from "api/admin/landing/hooks/useDeleteGalleryImage";
